...
## How to run
1. **Setup**: Activate the virtual environment using `.\.venv\Scripts\activate`.
2. **Run**: Execute the code using `python main.py`.
3. **Verify**: Check the terminal output to confirm success.